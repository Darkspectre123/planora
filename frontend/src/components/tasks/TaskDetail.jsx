...
export default function TaskDetail({ taskId, projectId, onClose, opened }) {
  ...
  <Text>
    Start: {currentTask.startDate ? formatDate(currentTask.startDate) : "N/A"}
  </Text>
  <Text>
    End: {currentTask.endDate ? formatDate(currentTask.endDate) : "N/A"}
  </Text>
</Stack>

<Stack spacing="xs">
  <Title order={5}>Priority</Title>
  <Text>{currentTask.priority || "medium"}</Text>
</Stack>
...
/>
            ...
            <FileInput
              ...
              multiple
              accept="image/*, application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document,  application/zip,application/vnd.rar, application/x-7z-compressed"
